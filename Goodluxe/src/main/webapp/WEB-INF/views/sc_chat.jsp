						...
						<div class="center_chat_content">
						   ...
						   <button onclick="popup()" class="center_chat_btn" >1:1 상담 시작</button>
						     <script type="text/javascript">
									...
									if('${member_isadmin}'=='Y'){
									window.open(url,name,"width=792,height=740,toolbar=no,status=no,location=no,scrollbars=no,menubar=no,resizable=no,left=200,right=200");
									}else{
										window.open(url,name,"width=393,height=703,toolbar=no,status=no,location=no,scrollbars=no,menubar=no,resizable=no,left=200,right=200");	
									}
